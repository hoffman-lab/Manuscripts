...
Freq2Test = [1:5:150]; Freq2Test=unique(Freq2Test);
...
for ii = 1:length(Significant)
    fill([Significant(ii)-0.5 Significant(ii)-0.5 Significant(ii)+0.5 Significant(ii)+0.5], [0 20 20 0], [0.9 0.9 0.9], 'edgecolor', [0.9 0.9 0.9])
    hold on
end
