...
load(fullfile('D:\HiTGun\Data', 'Spike_Table_LU_Merge.mat'));
...
%%
    ...
    for u = 2:numUnits+1
        ...
        %%
        spkLFP = zeros(2, length(downSampCSC));
        ...
        surrogate_spk_LFP_Convol = SPCshuffleTest(downSampCSC);
        ...
        sgtitle ({'Spike-Field Synchrony', ['Session: ', Session], ['Channel:', channel{1}], ['Unit: ', num2str(u-1)],['Number of samples: ', num2str(nsample)]})
        figName = [Session,'_','unit', num2str(u-1), channel{1}];
        Figure_Output_Directory = 'D:\HiTGun\Figures\LU\Spike-Field Synchrony'
...
save('LUSpikesTablePPC', 'Spikes',  '-v7.3')
